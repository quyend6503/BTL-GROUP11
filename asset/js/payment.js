...
payBtn.addEventListener("click", function() {
    ...
    `;
        ...
        const billHTML = `
            ...
            <p>Tạm tính <span>${subtotal.toLocaleString()}đ</span></p>
            <p>Phí ship <span>${shipping.toLocaleString()}đ</span></p>
            <p>Giảm giá <span>-${discountValue.toLocaleString()}đ</span></p>

            <hr>

            <p style="font-size:18px;font-weight:600;color:#D4AF37">
                Tổng thanh toán
